...
/**
 * Represents COM coclass ppDSApp.
 */
public class ppDSApp extends CoClass
{
    public static final CLSID CLASS_ID = CLSID.create("{2AFA62E2-5548-11D1-A6E1-006097C4E476}");

    public ppDSApp()
    {
    }

    public ppDSApp(ppDSApp that)
    {
        super(that);
    }
