...
public class SliderBeanInfo extends SimpleBeanInfo {
    ...
    ImageIcon colorIcon = new ImageIcon(getClass().getResource("images/SliderIcon16x16c.gif")); //30Jun2000: transparent color icon
    ImageIcon bwIcon = new ImageIcon(getClass().getResource("images/SliderIcon16x16bw.gif")); //30Jun2000: transparent black&white icon

    public SliderBeanInfo() {
        bundle=ResourceBundle.getBundle("gr.cti.eslate.slider.SliderBeanInfoBundle", Locale.getDefault());
    }
    ...
    private PropertyDescriptor makePropertyDescriptor(String property, String category) throws IntrospectionException{
     PropertyDescriptor pd=new PropertyDescriptor(property,Slider.class);
...
*/
            ...
            try{
                ...
                Method addListenerMethod = Slider.class.getMethod("addPropertyChangeListener", new Class[] {PropertyChangeListener.class});
                Method removelistenerMethod = Slider.class.getMethod("removePropertyChangeListener", new Class[] {PropertyChangeListener.class});
            ...
            try{
                ...
                Method addListenerMethod = Slider.class.getMethod("addVetoableChangeListener", new Class[] {VetoableChangeListener.class});
                Method removelistenerMethod = Slider.class.getMethod("removeVetoableChangeListener", new Class[] {VetoableChangeListener.class});
                MethodDescriptor md = new MethodDescriptor(listenerMethod);
            ...
            try{
                ...
                Method addListenerMethod = Slider.class.getMethod("addMouseListener", new Class[] {MouseListener.class});
                Method removelistenerMethod = Slider.class.getMethod("removeMouseListener", new Class[] {MouseListener.class});
            ...
            try{
                ...
                Method addListenerMethod = Slider.class.getMethod("addMouseMotionListener", new Class[] {MouseMotionListener.class});
                Method removelistenerMethod = Slider.class.getMethod("removeMouseMotionListener", new Class[] {MouseMotionListener.class});
                MethodDescriptor md = new MethodDescriptor(listenerMethod);
            ...
            try{
                ...
                Method addListenerMethod = Slider.class.getMethod("addComponentListener", new Class[] {ComponentListener.class});
                Method removelistenerMethod = Slider.class.getMethod("removeComponentListener", new Class[] {ComponentListener.class});
    ...
    public Image getIcon(int iconKind) {
     if(iconKind == BeanInfo.ICON_COLOR_16x16)
      return colorIcon.getImage();
     if (iconKind == BeanInfo.ICON_MONO_16x16)
      return bwIcon.getImage();
     return null;
    }

/*    public BeanDescriptor getBeanDescriptor() {
        return new BeanDescriptor(Slider.class, SliderCustomizer.class);
    }
*/
