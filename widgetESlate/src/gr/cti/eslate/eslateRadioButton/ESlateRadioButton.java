...
public class ESlateRadioButton extends JRadioButton implements ESlatePart, Externalizable {
    ...
    static final long serialVersionUID = 2093401218034382306L;
     ...
     * Constructs a new ESlateRadioButton
     *
     */

    public ESlateRadioButton() {
        this(null,null, false);
    }

    public ESlateRadioButton(String s, Icon i){
        this(s,i,false);
    }
    public ESlateRadioButton(String s, boolean selected){
        this(s,null, selected);
    }
    public ESlateRadioButton(Icon i, boolean selected){
        this(null,i,selected);
    }
    public ESlateRadioButton(String s){
        this(s,null, false);
    }
    public ESlateRadioButton(Icon i){
        this(null,i,false);
    }
    public ESlateRadioButton(Action a){
        this(null,null,false);
        setAction(a);
    }

    public ESlateRadioButton(String s, Icon i, boolean selected) {
        super(s,i,selected);
    ...
    public ESlateHandle getESlateHandle() {
        if (handle == null) {
            ...
            try {
                handle.setUniqueComponentName(bundleMessages.getString("ESlateRadioButton"));
            } catch (RenamingForbiddenException e) {
                e.printStackTrace();
            }
            handle.addPrimitiveGroup("gr.cti.eslate.scripting.logo.RadioButtonPrimitives");
