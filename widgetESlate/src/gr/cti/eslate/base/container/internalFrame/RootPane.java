...
public class RootPane extends JComponent implements Accessible {
    ...
    boolean componentChangingLayer = false;
...
//	SystemEventQueueUtilities.removeRunnableCanvas(this);
     ...
     * @param defaultButton the JButton which is to be the default button
     */
    ...
    static class DefaultAction extends AbstractAction {
        ...
        RootPane root;
        boolean press;
        DefaultAction(RootPane root, boolean press) {
            this.root = root;
            this.press = press;
        }
        ...
        public void actionPerformed(ActionEvent e) {
            javax.swing.JRootPane p = SwingUtilities.getRootPane(owner);
            RootPane rp = null;
            if (!RootPane.class.isAssignableFrom(p.getClass()))
                return;
//            else
//                rp = (RootPane) p;
            if (owner != null && rp == root) {
