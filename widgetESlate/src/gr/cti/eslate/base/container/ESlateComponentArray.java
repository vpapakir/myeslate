...
public class ESlateComponentArray extends ArrayBase {
    protected ESlateComponent[] baseArray;

    public ESlateComponentArray(int size, int growth) {
        super(size, growth, ESlateComponent.class);
    }

    public ESlateComponentArray(int size) {
        super(size, ESlateComponent.class);
    }

    public ESlateComponentArray() {
        super(ESlateComponent.class);
    }
    ...
    protected void setArray(Object array) {
        baseArray = (ESlateComponent[]) array;
    }
     ...
     */
    public int add(ESlateComponent value) {
     ...
     */
    public void add(int index, ESlateComponent value) {
     ...
     */
    public void set(int index, ESlateComponent value) {
        if (index < countPresent) {
            baseArray[index] = value;
        } else {
            throw new ArrayIndexOutOfBoundsException("Invalid index value");
     ...
     * Convert to an array.
     */
    public ESlateComponent[] toArray() {
        return (ESlateComponent []) buildArray();
    }

    /**
     * Return the first element in the collection.
     */
    public ESlateComponent front()
    {
      return get(0);
    }
     ...
     */
    public ESlateComponent popFront()
    {
      ESlateComponent first = get(0);
      remove(0);
      return first;
    }
     ...
     */
    public void pushFront(ESlateComponent value) {
        add(0, value);
    }
     ...
     */
    public int removeElements(int first, int last, ESlateComponent element, int count) {
     ...
     * @return	The number of Objects that were removed.
     */
    public int removeElements(ESlateComponent element) {
     ...
     * @return	The number of Objects that were removed.
     */
    public int removeElements(ESlateComponent element, int count) {
     ...
     * @return	The number of Objects that were removed.
     */
    public int removeElements(int first, int last, ESlateComponent element) {
     ...
     */
    public int replace(int first, int last, ESlateComponent oldValue, ESlateComponent newValue) {
        if (first >= 0 && first < countPresent &&
            last >= 0 && last < countPresent) {
	          int replaced = 0;
	          if (oldValue == null) {
     ...
     * @return	The number of Objects that were replaced.
     */
    public int replace(ESlateComponent oldValue, ESlateComponent newValue) {
     ...
     */
    public int count(int first, int last, ESlateComponent value) {
        if (first >= 0 && first < countPresent &&
            last >= 0 && last < countPresent) {
          	int found = 0;
          	if (value == null) {
     ...
     * @return	The number of Objects matched.
     */
    public int count(ESlateComponent value) {
     ...
     *			collection.
     */
    public int indexOf(int first, int last, ESlateComponent value) {
        if (first >= 0 && first < countPresent &&
            last >= 0 && last < countPresent) {
            if (value == null) {
                for (int i=first; i<=last; i++) {
     ...
     * @return	The requested index or -1 if the Object is not found.
     */
    public int indexOf(ESlateComponent value) {
        int result;
        try {
     ...
     *		otherwise.
     */
    public boolean contains(ESlateComponent value) {
