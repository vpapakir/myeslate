...
/**
 * Implements multiple input, multiple output shared object plugs.
 *
 * @author      Petros Kourouniotis
 * @author      Kriton Kyrimis
 * @version     2.0.21, 28-Sep-2007
 */
public class MultipleInputMultipleOutputPlug extends SharedObjectPlug
{
  /**
   * Constructs a multiple input, multiple output shared object plug.
  ...
  public MultipleInputMultipleOutputPlug(ESlateHandle handle,
