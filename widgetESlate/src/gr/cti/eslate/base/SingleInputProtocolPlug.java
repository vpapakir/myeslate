...
/**
 * Implements single input mixed mode mixed mode plugs.
 *
 * @author      Kriton Kyrimis
 * @version     2.0.21, 28-Sep-2007
 */
public class SingleInputProtocolPlug extends MixedModePlug
{
  /**
   * Constructs a single input mixed mode plug.
  ...
  public SingleInputProtocolPlug(ESlateHandle handle, ResourceBundle bundle,
