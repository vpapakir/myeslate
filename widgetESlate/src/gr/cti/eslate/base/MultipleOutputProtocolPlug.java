...
/**
 * Implements multiple output mixed mode plugs.
 *
 * @author      Kriton Kyrimis
 * @version     2.0.21, 28-Sep-2007
 */
public class MultipleOutputProtocolPlug extends MixedModePlug
{
  /**
   * Constructs a multiple output mixed mode plug.
  ...
  public MultipleOutputProtocolPlug(ESlateHandle handle, ResourceBundle bundle,
