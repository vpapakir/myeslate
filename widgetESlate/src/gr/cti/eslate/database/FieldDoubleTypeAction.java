...
public class FieldDoubleTypeAction extends AbstractAction {
    ...
    public FieldDoubleTypeAction(Database db, String name){
        iconEnabled = null;
        iconDisabled = null;
        dBase = db;
        actionName = name;
    ...
    public FieldDoubleTypeAction(Database db, String name, Icon iconEnabled, Icon iconDisabled) {
        dBase = db;
    ...
    public void actionPerformed(ActionEvent e) {
        dBase.menu.doubleType.setSelected(false);
        ...
        try{
            ...
            dBase.activeDBTable.changeFieldType(f, Double.class, true);
            ...
            dBase.updateNumOfSelectedRecords(dBase.activeDBTable);
            dBase.dbComponent.setCursor(defaultCursor);
            System.out.println("Serious inconsistency error in Database createMenuBar(): (27)");
            return;
         }
    ...
    public void setEnabled(boolean b) {
        super.setEnabled(b);
        dBase.menu.doubleType.setEnabled(b);
    }
}
