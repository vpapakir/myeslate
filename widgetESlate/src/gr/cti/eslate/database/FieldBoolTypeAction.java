...
public class FieldBoolTypeAction extends AbstractAction {
    ...
    public FieldBoolTypeAction(Database db, String name){
        iconEnabled = null;
        iconDisabled = null;
        dBase = db;
        actionName = name;
    ...
    public FieldBoolTypeAction(Database db, String name, Icon iconEnabled, Icon iconDisabled) {
        dBase = db;
    ...
    public void actionPerformed(ActionEvent e) {
        dBase.menu.boolType.setSelected(false);
        ...
        try{
            ...
            dBase.activeDBTable.changeFieldType(f, Boolean.class, true);
            ...
            dBase.updateNumOfSelectedRecords(dBase.activeDBTable);
            dBase.dbComponent.setCursor(defaultCursor);
            System.out.println("Serious inconsistency error in Database createMenuBar(): (29)");
            return;
         }
    ...
    public void setEnabled(boolean b) {
        super.setEnabled(b);
        dBase.menu.boolType.setEnabled(b);
    }
}
