...
public class IntegerFieldDataIterator extends FieldDataIterator {
    /** The field on which the iteration occurs */
    IntegerTableField field = null;

    /**
     * Construct myself to be a copy of an existing iterator.
     * @param iterator The iterator to copy.
     */
    public IntegerFieldDataIterator(IntegerFieldDataIterator iterator) {
     ...
     */
    public IntegerFieldDataIterator(IntBaseArrayDesc recIndexArray, int index, IntegerTableField field) {
     ...
     */
    public Object clone() {
        return new IntegerFieldDataIterator(this);
    }
    ...
    /**
     * Return the int at my current position.
