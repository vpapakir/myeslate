...
public class AnimationPrimitivesResource_el extends ListResourceBundle
{
  ...
  static final Object[][] contents = {
    {"PLAYFROMFRAME", "паинеапотоFRAME"},
    {"PLAYFROMFRAMETOFRAME", "паинеапотоFRAMEстоFRAME"},
    {"PLAYFROMLABEL", "паинеапотоомола"},
    {"PLAYFROMLABELTOLABEL", "паинеапотоомоластоомола"},
    {"GOTOFRAME", "пгцаиместоFRAME"},
  };
}
