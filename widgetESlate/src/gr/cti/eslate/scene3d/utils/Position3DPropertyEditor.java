...
//    Vector v;
    ...
    public Position3DPropertyEditor() {
        super();
    ...
    class PropertyEditorUI extends JPanel{
        ...
        SpinButton n1 = new SpinButton(),
                   n2 = new SpinButton(),
                   n3 = new SpinButton();
        JLabel label1 = new JLabel(bundleMessages.getString("XPos")),
               label2 = new JLabel(bundleMessages.getString("YPos")),
               label3 = new JLabel(bundleMessages.getString("ZPos"));
        ...
        private void fireChange(){
            ...
            Vec3d newObj = new Vec3d(((Number) editorUI.n1.getValue()).doubleValue(),
                    ((Number) editorUI.n2.getValue()).doubleValue(),
                    ((Number) editorUI.n3.getValue()).doubleValue());
            pcs.firePropertyChange("Position", oldObj, newObj);
        }
...
//            add(inPanel3);
    ...
    public static void main(String[] args){
        ...
        Position3DPropertyEditor editor = new Position3DPropertyEditor();
