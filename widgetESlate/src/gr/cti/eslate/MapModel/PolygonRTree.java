 ...
 */
public abstract class PolygonRTree extends RTree {
	/**
	 * Single presicion implementation of PolygonRTrees.
	 * @author  Giorgos Vasiliou
	 * @version 2.0, 22-Apr-2002
	 */
	public static class Float extends PolygonRTree {
	public Float() {
		super();
	...
	/**
	 * Double presicion implementation of PolygonRTrees.
	 * @author  Giorgos Vasiliou
	 * @version 2.0, 22-Apr-2002
	 */
	public static class Double extends PolygonRTree {
	public Double() {
		super();
