 ...
 */
public class ce extends BevelBorder {
    private static final long serialVersionUID=-1228107697585461755L;
    public ce(int type) {
        super(type);
    }
     ...
     */
    public ce(int bevelType, Color highlight, Color shadow) {
