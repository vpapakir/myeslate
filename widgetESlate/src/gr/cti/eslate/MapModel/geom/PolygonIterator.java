 ...
 */
public abstract class PolygonIterator implements java.awt.geom.PathIterator {
	/**
	 ...
	 * @version 1.0
	 */
	public static class FloatNoTransform extends PolygonIterator {
		public float[] points;
	 ...
	 * @version 1.0
	 */
	public static class FloatWithTransform extends PolygonIterator {
		public void initializeIterator() {
		...
		public int currentSegment(double[] coords) {
			...
			if (idx==partStop) {
				...
				if (idx==endidx)
					...
					return PathIterator.SEG_MOVETO;
			}/* CLOSE is useless. Shapefile format closes the paths itself.
			  else if (idx==prePartStop) {
				if (idx+2!=endidx)
					return PathIterator.SEG_CLOSE;
			}*/
	 ...
	 * @version 1.0
	 */
	public static class DoubleNoTransform extends PolygonIterator {
	 ...
	 * @version 1.0
	 */
	public static class DoubleWithTransform extends PolygonIterator {
		public void initializeIterator() {
			if (transpoints.length<points.length)
