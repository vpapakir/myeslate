...
public class PaletteBeanInfo extends SimpleBeanInfo {
    ResourceBundle bundle;
    ImageIcon mono16Icon = new ImageIcon(getClass().getResource("images/PaletteIcon16x16c.gif")); //transparent icon

    public PaletteBeanInfo() {
        bundle=ResourceBundle.getBundle("gr.cti.eslate.palette.PaletteBeanInfoBundle", Locale.getDefault());
    }
    ...
    private PropertyDescriptor makePropertyDescriptor(String property, String category) throws IntrospectionException{
     PropertyDescriptor pd=new PropertyDescriptor(property,Palette.class);
    ...
    public PropertyDescriptor[] getPropertyDescriptors() {
     try{
      return new PropertyDescriptor[] {
       ...
       makePropertyDescriptor("fillColor","Colors"),
...
*/
            ...
            try{
                ...
                Method addListenerMethod = Palette.class.getMethod("addPropertyChangeListener", new Class[] {PropertyChangeListener.class});
                Method removelistenerMethod = Palette.class.getMethod("removePropertyChangeListener", new Class[] {PropertyChangeListener.class});
            ...
            try{
                ...
                Method addListenerMethod = Palette.class.getMethod("addVetoableChangeListener", new Class[] {VetoableChangeListener.class});
                Method removelistenerMethod = Palette.class.getMethod("removeVetoableChangeListener", new Class[] {VetoableChangeListener.class});
                MethodDescriptor md = new MethodDescriptor(listenerMethod);
            ...
            try{
                ...
                Method addListenerMethod = Palette.class.getMethod("addMouseListener", new Class[] {MouseListener.class});
                Method removelistenerMethod = Palette.class.getMethod("removeMouseListener", new Class[] {MouseListener.class});
            ...
            try{
                ...
                Method addListenerMethod = Palette.class.getMethod("addMouseMotionListener", new Class[] {MouseMotionListener.class});
                Method removelistenerMethod = Palette.class.getMethod("removeMouseMotionListener", new Class[] {MouseMotionListener.class});
                MethodDescriptor md = new MethodDescriptor(listenerMethod);
            ...
            try{
                ...
                Method addListenerMethod = Palette.class.getMethod("addComponentListener", new Class[] {ComponentListener.class});
                Method removelistenerMethod = Palette.class.getMethod("removeComponentListener", new Class[] {ComponentListener.class});
...
/*    public BeanDescriptor getBeanDescriptor() {
        return new BeanDescriptor(Palette.class, PaletteCustomizer.class);
    }
*/
