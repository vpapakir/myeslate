...
public class EditorHorizontalAlignment extends TaggedIntegerPropertyEditor {
    ...
    private static String[] getPosNames() {
        ...
        name[0] = ESlateToggleButtonBeanInfo.bundleMessages.getString("left");
        name[1] = ESlateToggleButtonBeanInfo.bundleMessages.getString("center");
        name[2] = ESlateToggleButtonBeanInfo.bundleMessages.getString("right");
        name[3] = ESlateToggleButtonBeanInfo.bundleMessages.getString("leading");
        name[4] = ESlateToggleButtonBeanInfo.bundleMessages.getString("trailing");
        return name;
    }
}
