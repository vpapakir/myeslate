...
/**
 * This class implements a view and controller for the sound actor model.
 * @author	Augustine Grillakis
 * @version	1.0.0, 27-Jun-2002
 * @see		gr.cti.eslate.animationEditor.AnimationEditor
 */
public class SoundActorViewer extends BaseActorViewer {
   ...
   */
  public SoundActorViewer(AnimationEditor aniEditor, BaseActor newActor, Rectangle2D.Double newActorShape) {
    ...
    actorListener = new ActorListener() {
      public void segmentAdded(ActorEvent e) {
        if (animationEditor.processModelEvents == false)
          ...
          SegmentViewer segmentViewer = new SegmentViewer(SoundActorViewer.this, e.getSegment(), segmentShape);
...
//          Rectangle2D.Double milestoneShapeEnd = new Rectangle2D.Double();
          ...
          animationEditor.mainPanel.paintScoreImage(
            animationEditor.actorViewers.indexOf(SoundActorViewer.this),
            animationEditor.actorViewers.indexOf(SoundActorViewer.this),
            0,
            actorViewerRealWidth);
          animationEditor.mainPanel.repaint(
            0,
            animationEditor.actorViewers.indexOf(SoundActorViewer.this)*(animationEditor.ACTOR_VIEWER_HEIGHT+animationEditor.ACTOR_SPACE),
