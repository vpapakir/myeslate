...
public class MinimumNumberPropertyEditor extends PropertyEditorSupport {

    private PropertyChangeSupport pcs;
    SpinButton spinButton = new SpinButton();
    Double n = new Double(0.0);

    public MinimumNumberPropertyEditor() {
        super();
        pcs = new PropertyChangeSupport(this);
        spinButton.setModelType(2);
        double maxc = 999999999.999999999;
        double minc = -999999999.999999999;
