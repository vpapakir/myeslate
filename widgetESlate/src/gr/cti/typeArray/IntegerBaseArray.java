...
/**
 * 
 * A collection of Integers, similar to Vector.
 *
...
public class IntegerBaseArray extends ArrayBase
{
    static final long serialVersionUID = -5348046728512136879L;

    protected Integer[] baseArray;

    public IntegerBaseArray(int size, int growth) {
        super(size, growth, Integer.class);
    }

    public IntegerBaseArray(int size) {
        super(size, Integer.class);
    }

    public IntegerBaseArray() {
        super(Integer.class);
    }
    ...
    /**
     * Return the last Integer in the collection.
    ...
    /**
     * Remove and return the first Integer in the collection.
    ...
    /**
     * Insert a Integer in front of the first element in the collection.
    ...
    /**
     * Remove all elements that match a particular Integer.
     * @param   element The Integer to match.
     * @return  The number of Integers that were removed.
     */
    public int removeElements(Integer element)
    {
      return removeElements(0, countPresent-1, element, countPresent);
    }

    /**
     * Remove at most a given number of elements that match a particular Integer.
     * @param   element The Integer to match.
     * @param   count   The maximum number of elements to remove.
     * @return  The number of Integers that were removed.
     */
    public int removeElements(Integer element, int count)
    {
     ...
     * @return  The number of Integers that were removed.
     */
    public int removeElements(int first, int last, Integer element)
    {
     ...
     * @param   first           The index of the first element to consider.
     * @param   last            The index of the last element to consider.
     * @param   oldValue        The Integer to match.
     * @param   newValue        The new value.
     * @return  The number of Integers that were replaced.
     */
    public int replace(int first, int last, Integer oldValue, Integer newValue)
    {
      if (first >= 0 && first < countPresent &&
          last >= 0 && last < countPresent) {
        int replaced = 0;
    ...
    /**
     * Replace all elements that match a particular Integer with a new value.
     * @param   oldValue        The Integer to match.
     * @param   newValue        The new value.
     * @return  The number of Integers that were replaced.
     */
    public int replace(Integer oldValue, Integer newValue)
    {
     ...
     * @param   first   The index of the first element to consider.
     * @param   last    The index of the last element to consider.
     * @param   value   The Integer to match.
     * @return  The number of Integers matched.
     */
    public int count(int first, int last, Integer value)
    {
      if (first >= 0 && first < countPresent &&
          last >= 0 && last < countPresent) {
        int found = 0;
    ...
    /**
     * Count all elements that match a particular Integer.
     * @param   value   The Integer to match.
     * @return  The number of Integers matched.
     */
     ...
     * matches a particular Integer.
     * @param   first   The index of the first element to consider.
     * @param   last    The index of the last element to consider.
     * @param   value   The Integer to match.
     * @return  The requested index or -1 if the Integer is not found.
     ...
     *                  collection.
     */
    public int indexOf(int first, int last, Integer value)
    {
      if (first >= 0 && first < countPresent &&
          last >= 0 && last < countPresent) {
        if (value == null) {
    ...
    /**
     * Return the index of the first object that matches a particular Integer.
     * @param   value   The Integer to match.
     * @return  The requested index or -1 if the Integer is not found.
     */
    ...
    /**
     * Check if the collection contains a particular Integer.
     * @param   value   The Integer to match.
     * @return  True if the Integer is contained in the collection, false
     *          otherwise.
     */
