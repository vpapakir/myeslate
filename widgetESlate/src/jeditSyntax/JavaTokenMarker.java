 ...
 *
 * @author Slava Pestov
 * @version $Id: JavaTokenMarker.java,v 1.1 2007/12/14 15:07:05 kyrimis Exp $
 */
public class JavaTokenMarker extends CTokenMarker
{
	...
	public static KeywordMap getKeywords()
	{
		if(javaKeywords == null)
		{
			...
			javaKeywords.add("const",Token.KEYWORD1);
			...
			javaKeywords.add("enum",Token.KEYWORD1);
			...
			javaKeywords.add("goto",Token.KEYWORD1);
