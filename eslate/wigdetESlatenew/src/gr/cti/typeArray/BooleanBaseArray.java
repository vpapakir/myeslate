...
public class BooleanBaseArray extends ArrayBase
{
    static final long serialVersionUID = 1419020073320013308L;

    protected Boolean[] baseArray;

    public BooleanBaseArray(int size, int growth) {
        super(size, growth, Boolean.class);
    }

    public BooleanBaseArray(int size) {
        super(size, Boolean.class);
    }

    public BooleanBaseArray() {
        super(Boolean.class);
    }
