...
public class DoubleBaseArray extends ArrayBase
{
    static final long serialVersionUID = 8465780174725495620L;

    protected Double[] baseArray;

    public DoubleBaseArray(int size, int growth) {
        super(size, growth, Double.class);
    }

    public DoubleBaseArray(int size) {
        super(size, Double.class);
    }

    public DoubleBaseArray() {
        super(Double.class);
    }
