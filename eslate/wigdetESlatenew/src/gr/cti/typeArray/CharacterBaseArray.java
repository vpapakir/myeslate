...
/**
 * 
 * A collection of Characters, similar to Vector.
 *
...
public class CharacterBaseArray extends ArrayBase
{
    static final long serialVersionUID = 4072101163937971587L;

    protected Character[] baseArray;

    public CharacterBaseArray(int size, int growth) {
        super(size, growth, Character.class);
    }

    public CharacterBaseArray(int size) {
        super(size, Character.class);
    }

    public CharacterBaseArray() {
    ...
    /**
     * Return the last Character in the collection.
    ...
    /**
     * Remove and return the first Character in the collection.
     * @return  The removed Character.
     */
    public Character popFront()
    {
    ...
    /**
     * Insert a Character in front of the first element in the collection.
    ...
    /**
     * Remove all elements that match a particular Character.
     * @param   element The Character to match.
     * @return  The number of Characters that were removed.
     */
    public int removeElements(Character element)
    {
      return removeElements(0, countPresent-1, element, countPresent);
    }

    /**
     * Remove at most a given number of elements that match a particular Character.
     * @param   element The Character to match.
     * @param   count   The maximum number of elements to remove.
     * @return  The number of Characters that were removed.
     */
    public int removeElements(Character element, int count)
    {
     ...
     * @return  The number of Characters that were removed.
     */
    public int removeElements(int first, int last, Character element)
    {
     ...
     * Character with a new value.
     * @param   first           The index of the first element to consider.
     * @param   last            The index of the last element to consider.
     * @param   oldValue        The Character to match.
     * @param   newValue        The new value.
     * @return  The number of Characters that were replaced.
     */
    public int replace(int first, int last, Character oldValue, Character newValue)
    {
      if (first >= 0 && first < countPresent &&
          last >= 0 && last < countPresent) {
        int replaced = 0;
    ...
    /**
     * Replace all elements that match a particular Character with a new value.
     * @param   oldValue        The Character to match.
     * @param   newValue        The new value.
     * @return  The number of Characters that were replaced.
     */
    public int replace(Character oldValue, Character newValue)
    {
     ...
     */
    public int count(int first, int last, Character value)
    {
      if (first >= 0 && first < countPresent &&
          last >= 0 && last < countPresent) {
        int found = 0;
    ...
    /**
     * Count all elements that match a particular Character.
     * @param   value   The Character to match.
     * @return  The number of Characters matched.
     */
    public int count(Character value)
    {
     ...
     * @param   last    The index of the last element to consider.
     * @param   value   The Character to match.
     * @return  The requested index or -1 if the Character is not found.
     ...
     *                  collection.
     */
    public int indexOf(int first, int last, Character value)
    {
      if (first >= 0 && first < countPresent &&
          last >= 0 && last < countPresent) {
        if (value == null) {
    ...
    /**
     * Return the index of the first object that matches a particular Character.
     * @param   value   The Character to match.
     * @return  The requested index or -1 if the Character is not found.
     */
    ...
    /**
     * Check if the collection contains a particular Character.
     * @param   value   The Character to match.
     * @return  True if the Character is contained in the collection, false
     *          otherwise.
     */
