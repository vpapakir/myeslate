...
package gr.cti.utils; //1Dec1999: created from the code of JCheckMenu

import java.beans.*;
import javax.swing.*;

public class JCheckPopupMenu extends JPopupMenu
{
 /**
 ...
 public JCheckPopupMenu(){ //1Dec1999
  this("");
 }

 public JCheckPopupMenu(String title){
  super(title);
 }
