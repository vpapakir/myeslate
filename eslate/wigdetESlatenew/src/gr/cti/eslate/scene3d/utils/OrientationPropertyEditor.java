...
public class OrientationPropertyEditor extends PropertyEditorSupport {
    ...
    class PropertyEditorUI extends JPanel{
        ...
        SpinButton n1 = new SpinButton(),
                   n2 = new SpinButton(),
                   n3 = new SpinButton();
        JLabel label1 = new JLabel(bundleMessages.getString("PitchAngle")),
               label2 = new JLabel(bundleMessages.getString("YawAngle")),
               label3 = new JLabel(bundleMessages.getString("RollAngle"));
        ...
        private void fireChange(){
            ...
            Vec3d newObj = new Vec3d(((Number) editorUI.n1.getValue()).doubleValue(),
                    ((Number) editorUI.n2.getValue()).doubleValue(),
                    ((Number) editorUI.n3.getValue()).doubleValue());
            pcs.firePropertyChange("Orientation", oldObj, newObj);
        }
...
//            add(inPanel3);
    ...
    public static void main(String[] args){
        ...
        OrientationPropertyEditor editor = new OrientationPropertyEditor();
