...
/**
 * Implements single input, single output shared object plugs.
 *
 * @author      Petros Kourouniotis
 * @author      Kriton Kyrimis
 * @version     2.0.21, 28-Sep-2007
 */
public class SingleInputSingleOutputPlug extends SharedObjectPlug
{
  /**
   * Constructs a single input, single output shared object plug.
  ...
  public SingleInputSingleOutputPlug(ESlateHandle handle,
  ...
  public ImageIcon getIcon()
  {
    ...
    if (providers > 0 && dependents > 0) {
      if (icon_io == null) {
        icon_io = createPlugIcon(Plug.class.getResource("siso_io.gif"));
      }
      return icon_io;
    } else {
      if (providers > 0) {
