...
/**
 * This class extends the StructInputStream class so that close() can be
 * called multiple times.
 *
 * @author      Kriton Kyrimis
 * @version     2.0.0, 18-May-2006
 */
public class ESlateStructInputStream extends StructInputStream
{
  /**
   ...
   */
  public ESlateStructInputStream(StructFile f, Entry e) throws IOException
  {
    super(f, e);
  }
