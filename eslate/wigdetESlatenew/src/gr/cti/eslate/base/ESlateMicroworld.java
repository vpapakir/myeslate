...
*/
    ...
    System.out.println("DBG: getChildHandle -> nPairs="+nPairs);
    for (int i=0; i<nPairs; i++) {
      ...
      System.out.println("DBG: getChildHandle -> -6 "+firstHandleName[i]+" "+secondHandleName[i]);
      if (usesVectors) {
      ...
      System.out.println("DBG: getChildHandle -> -5 "+firstHandleName[i]+" "+secondHandleName[i]);
      Plug plug1;
      Vector iName1v;
      ...
      System.out.println("DBG: getChildHandle -> -4 "+firstHandleName[i]+" "+secondHandleName[i]);
      if (plug1 == null) {
      ...
      System.out.println("DBG: getChildHandle -> -3 "+firstHandleName[i]+" "+secondHandleName[i]);
      Plug plug2;
      Vector iName2v;
      ...
      System.out.println("DBG: getChildHandle -> -2 "+firstHandleName[i]+" "+secondHandleName[i]);
      if (plug2 == null) {
        if ((failedToConnect == 0) && (failedToLoad > 0)) {
          info.append("\n");
        }
      ...
      System.out.println("DBG: getChildHandle -> -1 "+firstHandleName[i]+" "+secondHandleName[i]);
      if (plug1 != null && plug2 != null) {
        ...
        if (!plug1.isConnected(plug2)) {
        	if(!plug2.name.equals("Browse a map")) {
        		System.out.println("DBG: getChildHandle -> Connect call 1 "+plug1.name);
            	connectComponent(plug1);
            	System.out.println("DBG: getChildHandle -> Connect call 2 "+plug2.name);
            	connectComponent(plug2);
        	}
        	//toggleConnect(plug1,plug2);
        	System.out.println("DBG: getChildHandle -> Connect call OK "+firstHandleName[i]+" "+secondHandleName[i]);        	
        }
      }
      System.out.println("DBG: getChildHandle -> OK "+firstHandleName[i]+" "+secondHandleName[i]);
    }
  ...
  private void notConnected(StringBuffer buf, String message, int nFailed)
  {
    if (nFailed == 0) {
      ...
      System.out.println("DBG: notConnected "+resources.getString("failedToConnect"));
    }
    buf.append("\n        ");
    buf.append(message);
  }
