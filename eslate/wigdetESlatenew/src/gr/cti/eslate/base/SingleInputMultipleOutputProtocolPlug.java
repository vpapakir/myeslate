...
/**
 * Implements single input, multiple output mixed mode plugs.
 *
 * @author      Kriton Kyrimis
 * @version     2.0.21, 28-Sep-2007
 */
public class SingleInputMultipleOutputProtocolPlug extends MixedModePlug
{
  /**
   * Constructs a single input, multiple output mixed mode plug.
  ...
  public SingleInputMultipleOutputProtocolPlug(ESlateHandle handle,
