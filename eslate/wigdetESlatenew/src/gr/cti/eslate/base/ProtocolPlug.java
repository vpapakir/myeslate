...
/**
 * Base class for plugs associated with protocols.
 *
 * @author      Kriton Kyrimis
 * @version     2.0.21, 28-Sep-2007
 */
public abstract class ProtocolPlug extends Plug implements IProtocolPlug
{
  /**
   ...
   * {@link gr.cti.eslate.base.ProtocolPlug#getProtocolPlugs()}.
   ...
   * When two protocol plugs that participate in the hosting mechanism are
   * connected, the component owning the "right" plug will be hosted by the
   * component owning the "left" plug. Disconnecting these plugs will break
   * the established hosting relationship.
   * @param     hostingPlug     True if yes, false otherwise.
   */
  public void setHostingPlug(boolean hostingPlug)
  {
    internals.setHostingPlug(hostingPlug);
  }
   ...
   */
  public boolean isHostingPlug()
  {
    return internals.isHostingPlug();
  }
  ...
  @SuppressWarnings("unchecked")
  protected ProtocolPlug(ESlateHandle handle, ResourceBundle bundle,
  ...
  @SuppressWarnings("unchecked")
  protected ProtocolPlug(ESlateHandle handle, String name, Color cl,
