...
/**
 * Implements multiple input, single output shared object plugs.
 *
 * @author      Petros Kourouniotis
 * @author      Kriton Kyrimis
 * @version     2.0.21, 28-Sep-2007
 */
public class MultipleInputSingleOutputPlug extends SharedObjectPlug
{
  /**
   * Constructs a multiple input, single output shared object plug.
  ...
  public MultipleInputSingleOutputPlug(ESlateHandle handle,
