 ...
 */
public class ScriptListenerMethodNode implements MutableTreeNode, ScriptListenerTreeNode {
    ...
    public ScriptListenerMethodNode(String methodName) {
        this.methodName = methodName;
        if (methodName.startsWith("get"))
            nodeName = methodName.substring(3);
        else
            nodeName = methodName;
    }
