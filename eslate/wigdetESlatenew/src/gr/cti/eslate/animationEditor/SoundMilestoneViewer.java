...
/**
 * This class implements a view and controller for the sound milestone model.
 * @author	Augustine Grillakis
 * @version	1.0.0, 27-Jun-2002
 * @see		gr.cti.eslate.animationEditor.SoundSegmentViewer
 */
public class SoundMilestoneViewer extends BaseMilestoneViewer{
  int zeroTime;
   ...
   */
  public SoundMilestoneViewer(BaseSegmentViewer newSegmentViewer, BaseMilestone newMilestone, Ellipse2D.Double newMilestoneShape) {
