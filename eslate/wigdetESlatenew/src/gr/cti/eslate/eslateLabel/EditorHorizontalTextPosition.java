...
public class EditorHorizontalTextPosition extends TaggedIntegerPropertyEditor {
    public EditorHorizontalTextPosition() {
        super("HorizontalTextPosition", getPos(), getPosNames());
