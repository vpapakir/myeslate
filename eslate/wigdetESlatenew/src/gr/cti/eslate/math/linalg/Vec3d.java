...
public class Vec3d {
    ...
    public static final Vec3d NEG_X_AXIS = new Vec3d(-1, 0, 0);
    public static final Vec3d NEG_Y_AXIS = new Vec3d(0, -1, 0);
    public static final Vec3d NEG_Z_AXIS = new Vec3d(0, 0, -1);
