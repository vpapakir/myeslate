 ...
 * properties of a visual group.
 *
 * @author      Kriton Kyrimis
 * @version     2.0.0, 22-May-2006
 */
class VisualGroupPropertiesDialog extends JDialog
{
  /**
  ...
  /**
   * The information describing the visual group.
   */
  private VisualGroupEditorGroupInfo info;
  /**
   ...
   * @param     info    The information decsribing the visual group
   */
  VisualGroupPropertiesDialog(Component owner, VisualGroupEditorGroupInfo info)
  {
    super(
      (Frame)(SwingUtilities.getAncestorOfClass(Frame.class, owner)),
      resources.getString("vGroupPropDialogTitle"),
      true
    );
    ...
    cBox = new JCheckBox(resources.getString("groupVisible"), info.visible);
    cBoxPanel.add(cBox);
