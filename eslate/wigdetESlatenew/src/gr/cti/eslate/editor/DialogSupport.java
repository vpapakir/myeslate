 ...
 * This is a modified version of org/netbeans/editor/DialogSupport.java,
 * modified so that modal dialogs have a Frame as an owner,
 *
 * @author      pnejedly
...
public class DialogSupport {
     ...
     */
    public static Dialog createDialog( Frame owner, String title, JPanel panel, boolean modal,
        ...
        return factory.createDialog(owner, title, panel, modal, buttons, sidebuttons,
                defaultIndex, cancelIndex, listener );
    }
    
    /** The method for setting custom factory for creating dialogs via
     * the {@link #createDialog(java.awt.Frame, java.lang.String, javax.swing.JPanel, boolean, javax.swing.JButton[], boolean, int, int, java.awt.event.ActionListener) createDialog} method.
    ...
    public static interface DialogFactory {
         ...
         * @return newly created <CODE>Dialog</CODE>
         */
        public Dialog createDialog( Frame owner, String title, JPanel panel, boolean modal,
    ...
    private static class DefaultDialogFactory extends WindowAdapter implements DialogFactory, ActionListener {
        ...
        public Dialog createDialog(Frame owner, String title, JPanel panel, boolean modal,
            ...
            JDialog d = new JDialog( owner, title, modal );
