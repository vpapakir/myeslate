...
public class BundleInfo extends ListResourceBundle {
    ...
    static final Object[][] contents={
        //ESlateInfo
        {"compo",           "Map Browser component, version"},
        {"part",            "Part of the E-Slate environment (http://E-Slate.cti.gr)"},
        {"development",     "Development: G. Vasiliou"},
        {"contribution",    "Contribution: M. Koutlis, G. Tsironis, K. Kyrimis, N. Renieri"},
