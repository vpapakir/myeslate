...
public class ESlateCheckBox extends JCheckBox implements ESlatePart, Externalizable {
    ...
    static final long serialVersionUID = 442453110737612862L;
     ...
     * Constructs a new ESlateCheckBox
     *
     */

    public ESlateCheckBox() {
        this(null,null, false);
    }

    public ESlateCheckBox(String s, Icon i){
        this(s,i,false);
    }
    public ESlateCheckBox(String s, boolean selected){
        this(s,null, selected);
    }
    public ESlateCheckBox(Icon i, boolean selected){
        this(null,i,selected);
    }
    public ESlateCheckBox(String s){
        this(s,null, false);
    }
    public ESlateCheckBox(Icon i){
        this(null,i,false);
    }
    public ESlateCheckBox(Action a){
        this(null,null,false);
        setAction(a);
    }

    public ESlateCheckBox(String s, Icon i, boolean selected){
        super(s,i,selected);
    ...
    public ESlateHandle getESlateHandle() {
        if (handle == null) {
            ...
            try {
                handle.setUniqueComponentName(bundleMessages.getString("ESlateCheckBox"));
            } catch (RenamingForbiddenException e) {
                e.printStackTrace();
            }
            handle.addPrimitiveGroup("gr.cti.eslate.scripting.logo.CheckBoxPrimitives");
