...
/**
 * BeanInfo for QuadraticCurve object.
 *
 * @version     2.0.13, 24-Jun-2008
 * @author      Kriton Kyrimis
 */
public class QuadraticCurveBeanInfo extends SimpleBeanInfo
{
  /**
   * Localized resources.
   */
  ResourceBundle resources = ResourceBundle.getBundle(
    "gr.cti.eslate.stage.objects.QuadraticCurveResource",
    Locale.getDefault()
  );
  ...
  public PropertyDescriptor[] getPropertyDescriptors()
  {
    try {
      ...
      pd = new PropertyDescriptor(
        "preparedForCopy", QuadraticCurve.class,
  ...
  public EventSetDescriptor[] getEventSetDescriptors()
  {
    try {
      ...
      addListenerMethod = QuadraticCurve.class.getMethod(
        "addActorNameListener", new Class[] {ActorNameListener.class}
      );
      removeListenerMethod = QuadraticCurve.class.getMethod(
