...
class PolygonLayerProperties extends JDialog {
	PolygonLayerProperties() {
		...
		//Localization
		lblView.setText(MapCreator.bundleCreator.getString("polygonview"));
		...
		cbxFilled.setText(MapCreator.bundleCreator.getString("filledpolygon"));
	...
	protected void setLayer(PolygonLayer l) {
		if (firstTimeShown) {
			firstTimeShown=false;
			switch (l.getPaintMode()) {
				case IPolygonLayerView.PAINT_AS_STRAIGHT_LINE:
			...
			cbxFilled.setSelected(l.isPolygonFilled());
	...
	protected boolean isPolygonFilled() {
	...
	private void jbInit() throws Exception {
		...
		cbxFilled.setText("Filled polygons");
		...
		this.getContentPane().add(cbxFilled, new com.thwt.layout.LayoutConstraint(
					new com.thwt.layout.ContainerAnchor(Anchor.Left, 5),
					new com.thwt.layout.EdgeAnchor(lblPixels, Anchor.Bottom, Anchor.Below, Anchor.Top, 15),
					new com.thwt.layout.PreferredDimAnchor(Anchor.Width, 0, 1.0),
					new com.thwt.layout.PreferredDimAnchor(Anchor.Height, 0, 1.0)));
		this.getContentPane().add(cmbAntialias, new com.thwt.layout.LayoutConstraint(
					new com.thwt.layout.ContainerAnchor(Anchor.Left, 35),
					new com.thwt.layout.EdgeAnchor(cbxFilled, Anchor.Bottom, Anchor.Below, Anchor.Top, 10),
					new com.thwt.layout.PreferredDimAnchor(Anchor.Width, 0, 1.0),
					new com.thwt.layout.PreferredDimAnchor(Anchor.Height, 0, 1.0)));
	...
	private JRadioButton rbtnStraight = new JRadioButton() {
		public void paintComponent(Graphics g) {
			...
			PolygonLayerProperties.this.repaint();
		}
	};
	...
	JNumberField txtErrorTol = new JNumberField("-1");
