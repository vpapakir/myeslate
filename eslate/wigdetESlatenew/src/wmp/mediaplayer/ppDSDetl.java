...
/**
 * Represents COM coclass ppDSDetl.
 */
public class ppDSDetl extends CoClass
{
    public static final CLSID CLASS_ID = CLSID.create("{31C48C32-70B0-11D1-A708-006097C4E476}");

    public ppDSDetl()
    {
    }

    public ppDSDetl(ppDSDetl that)
    {
        super(that);
    }
