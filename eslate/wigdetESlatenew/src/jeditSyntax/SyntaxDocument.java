 ...
 *
 * @author Slava Pestov
 * @version $Id: SyntaxDocument.java,v 1.1 2007/12/14 15:07:05 kyrimis Exp $
 */
public class SyntaxDocument extends PlainDocument
{
    ...
    /**
     * Undoable edit currently being built.
     */
    private InsertUndo undoEdit;
	...
	public void endCompoundEdit()
        {
          if (undoEdit != null) {
            ...
            fireUndoableEditUpdate(new UndoableEditEvent(this, undoEdit));
            undoEdit = null;
          }
        }
	...
	protected void fireRemoveUpdate(DocumentEvent evt)
	{
        ...
        {
          if (undoEdit != null) {
            if (undoEdit.offset < 0) {
              undoEdit.offset = offs;
            }
            undoEdit.insertedText += str;
          }
        ...
        throws BadLocationException
        {
          if (undoEdit != null) {
            undoEdit.offset = offs;
            undoEdit.removedText = getText(offs, len);
          }
        ...
        /**
         * Checks if it is possible to undo an edit.
         * @return      True if it is possible to undo an edit, false
         *              otherwise.
         */
        ...
        /**
         * Checks if it is possible to redo an edit.
         * @return      True if it is possible to redo an edit, false
         *              otherwise.
         */
