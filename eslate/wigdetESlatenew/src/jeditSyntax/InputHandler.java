 ...
 *
 * @author Slava Pestov
 * @version $Id: InputHandler.java,v 1.1 2007/12/14 15:07:05 kyrimis Exp $
 * @see jeditSyntax.DefaultInputHandler
 */
...
public abstract class InputHandler extends KeyAdapter
{
	...
	public static final ActionListener FIND_NEXT = new findNext();
	public static final ActionListener REPLACE = new replace();
	public static final ActionListener GOTO_LINE = new gotoLine();
	 ...
	 * action listener with the key as a the action command.
		...
		public void actionPerformed(ActionEvent evt)
		{
			...
			else
			{
				...
				caret = TextUtilities.findWordEnd(lineText,caret,noWordSep);
                        ...
                        textArea.remove(start, (caret + lineStart) - start);
		}
	}
	...
	public static class findNext implements ActionListener,
		InputHandler.NonRepeatable
	{
		public void actionPerformed(ActionEvent evt)
		{
	...
	public static class gotoLine implements ActionListener,
		InputHandler.NonRepeatable
	{
		public void actionPerformed(ActionEvent evt)
		{
