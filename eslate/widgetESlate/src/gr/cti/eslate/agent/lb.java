 ...
 */
public class lb extends BevelBorder {
    private static final long serialVersionUID=-6845530127472227397L;
    public lb(int type) {
        super(type);
    }
     ...
     */
    public lb(int bevelType, Color highlight, Color shadow) {
