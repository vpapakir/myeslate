...
public class PopupMenuPropertyEditor extends PropertyEditorSupport {
    ...
    PopupEditorDialog dialog;
    static boolean changedValues;
    int size;

    public PopupMenuPropertyEditor() {
        super();
    ...
    public java.awt.Component getCustomEditor() {
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                dialog = new PopupEditorDialog(oldtree, frame, true);
                PopupEditorDialog.showDialog(dialog, button, true);
