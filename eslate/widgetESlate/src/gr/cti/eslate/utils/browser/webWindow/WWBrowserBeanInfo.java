...
/**
 * BeanInfo for WWBrowser.
 *
 * @version     2.0.0, 18-May-2006
 * @author      Kriton Kyrimis
 */

public class WWBrowserBeanInfo extends SimpleBeanInfo
{
  /**
   * Localized resources.
   */
  ...
  public EventSetDescriptor[] getEventSetDescriptors()
  {
    ...
    try {
      ...
      addListenerMethod = WWBrowser.class.getMethod(
        "addLinkFollowedListener", new Class[] {LinkFollowedListener.class}
      );
      removeListenerMethod = WWBrowser.class.getMethod(
