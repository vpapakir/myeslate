...
/**
 * This class implements a view and controller for the segment model.
 * @author	Augustine Grillakis
 * @version	1.0.0, 13-Mar-2002
 * @see		gr.cti.eslate.animationEditor.ActorViewer
 */
public class SegmentViewer extends BaseSegmentViewer {
   ...
   */
  public SegmentViewer(BaseActorViewer newActorViewer, BaseSegment newSegment, Rectangle2D.Double newSegmentShape) {
...
//          Rectangle2D.Double milestoneShape = new Rectangle2D.Double();
          ...
          MilestoneViewer milestoneViewer = new MilestoneViewer(SegmentViewer.this, e.getMilestone(), milestoneShape);
