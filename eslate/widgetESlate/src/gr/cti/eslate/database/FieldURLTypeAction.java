...
public class FieldURLTypeAction extends AbstractAction {
    ...
    public FieldURLTypeAction(Database db, String name){
        iconEnabled = null;
        iconDisabled = null;
        dBase = db;
        actionName = name;
    ...
    public FieldURLTypeAction(Database db, String name, Icon iconEnabled, Icon iconDisabled) {
        dBase = db;
    ...
    public void actionPerformed(ActionEvent e) {
        dBase.menu.urlType.setSelected(false);
        ...
        try{
            ...
            dBase.activeDBTable.changeFieldType(f, java.net.URL.class, true);
            ...
            dBase.statusToolbarController.setMessageLabelColor(Color.white);
            dBase.updateNumOfSelectedRecords(dBase.activeDBTable);
            System.out.println("Serious inconsistency error in Database createMenuBar(): (32)");
            return;
         }
    ...
    public void setEnabled(boolean b) {
        super.setEnabled(b);
        dBase.menu.urlType.setEnabled(b);
    }
}
