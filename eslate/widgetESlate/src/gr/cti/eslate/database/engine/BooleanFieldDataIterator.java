...
public class BooleanFieldDataIterator extends FieldDataIterator {
    /** The field on which the iteration occurs */
    BooleanTableField field = null;

    /**
     * Construct myself to be a copy of an existing iterator.
     * @param iterator The iterator to copy.
     */
    public BooleanFieldDataIterator(BooleanFieldDataIterator iterator) {
     ...
     */
    public BooleanFieldDataIterator(IntBaseArrayDesc recIndexArray, int index, BooleanTableField field) {
     ...
     */
    public Object clone() {
        return new BooleanFieldDataIterator(this);
    }
