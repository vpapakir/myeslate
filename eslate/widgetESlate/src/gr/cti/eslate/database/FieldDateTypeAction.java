...
public class FieldDateTypeAction extends AbstractAction {
    ...
    public FieldDateTypeAction(Database db, String name){
        iconEnabled = null;
        iconDisabled = null;
        dBase = db;
        actionName = name;
    ...
    public FieldDateTypeAction(Database db, String name, Icon iconEnabled, Icon iconDisabled) {
        dBase = db;
    ...
    public void actionPerformed(ActionEvent e) {
        dBase.menu.dateType.setSelected(false);
        ...
        try{
            ...
            dBase.activeDBTable.changeFieldType(f, CDate.class, true);
            ...
            dBase.updateNumOfSelectedRecords(dBase.activeDBTable);
            dBase.dbComponent.setCursor(defaultCursor);
            System.out.println("Serious inconsistency error in Database createMenuBar(): (30)");
            return;
         }
    ...
    public void setEnabled(boolean b) {
        super.setEnabled(b);
        dBase.menu.dateType.setEnabled(b);
