...
public class FieldSortDescendingAction extends AbstractAction {
    DBTable dbTable = null;

    public FieldSortDescendingAction(DBTable dbTable, String name) {
        super(name);
...
//        dbTable.clickCounter.stop();
        ...
        try{
            dbTable.sortOnField(field.getName(), false, 0,
