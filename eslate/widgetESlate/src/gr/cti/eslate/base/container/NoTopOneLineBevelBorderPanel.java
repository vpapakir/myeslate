...
public class NoTopOneLineBevelBorderPanel extends JPanel {
...
//    ColorChoosePanel shadowInnerPanel;
    ...
    NoTopOneLineBevelBorder border;

    public NoTopOneLineBevelBorderPanel(NoTopOneLineBevelBorder b, final JPanel samplePanel) {
        super(true);
        this.border = b;
        ...
        // Initialization
        if (border != null && border.getBevelType() == NoTopOneLineBevelBorder.RAISED)
        ...
        typeBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int type = NoTopOneLineBevelBorder.RAISED;
                if (selectedItem.equals(LOWERED))
                    type = NoTopOneLineBevelBorder.LOWERED;
                NoTopOneLineBevelBorder oldBorder = border;
                border = new NoTopOneLineBevelBorder(type,
                                         border.getHighlightOuterColor(samplePanel),
                                         border.getShadowOuterColor(samplePanel));
        ...
        hightlightPanel.addPropertyChangeListener(new PropertyChangeListener() {
            public void propertyChange(PropertyChangeEvent evt) {
                if (evt.getPropertyName().equals("Color")) {
                    ...
                    NoTopOneLineBevelBorder oldBorder = border;
                    border = new NoTopOneLineBevelBorder(border.getBevelType(),
                                             hightlightColor,
                                             border.getShadowOuterColor(samplePanel));
                    firePropertyChange("Border", oldBorder, border);
//                    if (samplePanel != null)
...
//                        samplePanel.setBorder(border);
    ...
    public NoTopOneLineBevelBorder getNoTopOneLineBevelBorder() {
        return border;
    }

    public void setNoTopOneLineBevelBorder(NoTopOneLineBevelBorder b, java.awt.Component c) {
        border = b;
        if (border.getBevelType() == NoTopOneLineBevelBorder.RAISED)
            typeBox.setSelectedItem(RAISED);
        else
            typeBox.setSelectedItem(LOWERED);
