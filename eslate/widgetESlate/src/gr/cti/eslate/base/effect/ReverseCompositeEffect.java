...
/**
 * This class implements an alpha composite effect (fade out).
 *
 * @author      Augustine Grillakis
 * @author      Kriton Kyrimis
 * @version     2.0.0, 18-May-2006
 */
public class ReverseCompositeEffect implements EffectInterface
{
  /**
