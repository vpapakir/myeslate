...
/**
 * Implements multiple input shared object plugs.
 *
 * @author      Petros Kourouniotis
 * @author      Kriton Kyrimis
 * @version     2.0.21, 28-Sep-2007
 */
public class MultipleInputPlug extends SharedObjectPlug
{
  /**
   * Constructs a multiple input shared object plug.
  ...
  public MultipleInputPlug(ESlateHandle handle, ResourceBundle bundle,
