 ...
 */
public class LeftSingleConnectionProtocolPlug extends ProtocolPlug
{
  /**
  ...
  public LeftSingleConnectionProtocolPlug(ESlateHandle handle,
  ...
  public LeftSingleConnectionProtocolPlug(ESlateHandle handle,
                                         ResourceBundle bundle, String key,
                                         Color cl, Class protocol,
                                         Object implementor, Vector exported)
    throws InvalidPlugParametersException
  {
    super(handle, bundle, key, cl, null, protocol, implementor,
          LEFT_ROLE, null);
  ...
  public ImageIcon getIcon()
  {
    if (internals.protocolPlugs.size() == 0) {
      if (icon == null) {
        icon = createPlugIcon(Plug.class.getResource("scpa.gif"));
      }
      return icon;
    } else {
      if (icon_c == null) {
