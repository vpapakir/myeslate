...
/**
 * The Button Tool for the Toolbar.
 * <P>
 *
 * @author	Giorgos Vasiliou
 * @version	4.0.0, 02-Apr-2002
 */
public class MapViewerButton extends ESlateButton implements ToolComponent {

	public MapViewerButton() {
		super();
