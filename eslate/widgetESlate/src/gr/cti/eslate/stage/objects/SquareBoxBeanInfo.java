...
/**
 * BeanInfo for Square Box object.
 *
 * @version     2.0.13, 24-Jun-2008
 * @author      Kriton Kyrimis
 */
public class SquareBoxBeanInfo extends SimpleBeanInfo
{
  /**
   * Localized resources.
   */
  ResourceBundle resources = ResourceBundle.getBundle(
    "gr.cti.eslate.stage.objects.SquareBoxResource",
    Locale.getDefault()
  );
  ...
  public PropertyDescriptor[] getPropertyDescriptors()
  {
    try {
      ...
      pd = new PropertyDescriptor(
        "preparedForCopy", SquareBox.class,
  ...
  public EventSetDescriptor[] getEventSetDescriptors()
  {
    try {
      ...
      addListenerMethod = SquareBox.class.getMethod(
        "addActorNameListener", new Class[] {ActorNameListener.class}
      );
      removeListenerMethod = SquareBox.class.getMethod(
